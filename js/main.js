...
(function () {
  ...
  function setCanvasImages() {
    ...
    for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
      ...
      sceneInfo[0].objs.videoImage.push(imgEle);
    }
    ...
    for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
      ...
      sceneInfo[2].objs.videoImage.push(imgEle2);
    }
  }
  setCanvasImages();
  function setLayout() {
    ...
    const heightRatio = window.innerHeight / 970;
  ...
  function playAnimation() {
    ...
    switch (currentScene) {
      case 0:
        ...
        objs.context.drawImage(objs.videoImage[sequence], 0, 0, 1920, 1080);
      ...
      case 2:
        ...
        //console.log(sequence)
        objs.context.drawImage(objs.videoImage[sequence2], 0, 0, 1920, 1080);
        //canvas opacity
